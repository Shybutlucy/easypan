...
CREATE TABLE `file_info` (
  `id` varchar(15) COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件ID',
  ...
  `file_pid` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件父ID',
  `file_size` bigint DEFAULT NULL COMMENT '文件大小',
  `filename` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件名',
  `file_cover` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件封面',
...
INSERT INTO `file_info` (`id`, `user_id`, `file_md5`, `file_pid`, `file_size`, `filename`, `file_cover`, `file_path`, `folder_type`, `file_category`, `file_type`, `status`, `recovery_time`, `version`, `deleted`, `create_time`, `update_time`) VALUES ('bZ7Z8p9coI', '3494146119', NULL, 'awA4FaVY6b', NULL, '甜蜜家园', NULL, NULL, 1, NULL, NULL, 2, NULL, 1, 0, '2023-06-05 19:01:15', '2023-06-06 22:06:16');
...
CREATE TABLE `file_share` (
  `id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分享ID',
  `file_id` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件ID',
  `user_id` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户ID',
  `valid_type` tinyint(1) DEFAULT NULL COMMENT '有效期类型 0:1天 1:7天 2:30天 3:永久有效',
  `code` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '提取码',
...
CREATE TABLE `user_info` (
  ...
  `email` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '邮箱',
  `qq_open_id` varchar(35) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'QQ openID',
  `qq_avatar` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'QQ头像',
...
-- ----------------------------
BEGIN;
INSERT INTO `user_info` (`id`, `nickname`, `email`, `qq_open_id`, `qq_avatar`, `password`, `last_login_time`, `use_space`, `total_space`, `status`, `version`, `deleted`, `create_time`, `update_time`) VALUES ('3494146119', 'swcode', '2627311935@qq.com', NULL, NULL, '5a1c646dd5e3c9bb4fbdf61ea4c99f4b', NULL, 611108689, 1073741824, 1, 1, 0, '2023-07-14 14:38:31', '2023-07-14 14:38:32');
COMMIT;
